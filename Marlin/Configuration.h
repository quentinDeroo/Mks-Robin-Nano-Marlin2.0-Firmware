...
#define STRING_CONFIG_H_AUTHOR "(Quentin Deroo, sapphire_pro_TFT35)" // Who made the changes.
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (216)    // Y point for Z homing when homing all axes (G28).
#endif
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), (Y_MAX_POS - 110), 50 }
